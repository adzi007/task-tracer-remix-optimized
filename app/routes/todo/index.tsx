...
export default function Index() {
    ...
    const renderTodos = useMemo(() => {
        return todos.map((data:any, index) => (
              <tr className="bg-white border-b border-gray-200" key={index}>
                ...
                <td className="px-6 py-4">{ data.completed ? "true":"false" }</td>
                <td className="px-6 py-4">
                    <button type="button" className="p-2.5 bg-white text-black border rounded-md">Delete</button>
                </td>
            </tr>
        ))
    },[todos])
    ...
    return (
        <div className="max-w-3xl bg-gray-300 mx-auto p-4">
          ...
          <h1 className="text-2xl font-semibold" >Hello Todo</h1>
